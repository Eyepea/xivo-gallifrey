...
<?
//$server_minutes = date('H')*60;
//$server_minutes = $server_minutes + date('i');
//$server_date = date('Y-m-d');
//echo "Current date/time: ".date('Y-m-d H:i:s')." ($server_minutes)<BR>";
echo "<h2>". $lang["$language"]['realtime_agent_status'] ."</h2>";
