...
CREATE TABLE `queue` (
 ...
 `announce-frequency` int(11) unsigned,
 `periodic-announce-frequency` int(11) unsigned,
...
INSERT INTO `extensions` VALUES(NULL,0,'features','_*98',1,'VoiceMailMain','${CALLERID(num)}@${CONTEXT}|s','voicemsg');
INSERT INTO `extensions` VALUES(NULL,0,'features','_*98',2,'Hangup','','voicemsg');
INSERT INTO `extensions` VALUES(NULL,0,'features','_*20',1,'Macro','features|FWD/Unc/Status|||1','fwdundoall');
INSERT INTO `extensions` VALUES(NULL,0,'features','_*20',2,'Macro','features|FWD/RNA/Status|||1','fwdundoall');
INSERT INTO `extensions` VALUES(NULL,0,'features','_*20',3,'Macro','features|FWD/Busy/Status|all-forward-off|all-forward-off|1','fwdundoall');
INSERT INTO `extensions` VALUES(NULL,0,'features','_*21',1,'Macro','features|FWD/Unc/Status|forward-on|forward-off|1','fwdundounc');
INSERT INTO `extensions` VALUES(NULL,0,'features','_*22',1,'Macro','features|FWD/RNA/Status|forward-on|forward-off|1','fwdundorna');
INSERT INTO `extensions` VALUES(NULL,0,'features','_*23',1,'Macro','features|FWD/Busy/Status|forward-on|forward-off|1','fwdundobusy');
...
INSERT INTO `extensions` VALUES(NULL,0,'features','_*10',4,'Macro','checkdbfeatures|FWD/Unc/Status|1|FWD/Unc/Number','phonestatus');
INSERT INTO `extensions` VALUES(NULL,0,'features','_*10',5,'Playback','forward-busy','phonestatus');
INSERT INTO `extensions` VALUES(NULL,0,'features','_*10',6,'Macro','checkdbfeatures|FWD/Busy/Status|1|FWD/Busy/Number','phonestatus');
INSERT INTO `extensions` VALUES(NULL,0,'features','_*10',7,'Playback','forward-rna','phonestatus');
INSERT INTO `extensions` VALUES(NULL,0,'features','_*10',8,'Macro','checkdbfeatures|FWD/RNA/Status|1|FWD/RNA/Number','phonestatus');
INSERT INTO `extensions` VALUES(NULL,0,'features','_*10',9,'Playback','vm-status','phonestatus');
INSERT INTO `extensions` VALUES(NULL,0,'features','_*10',10,'Macro','checkdbfeatures|VM','phonestatus');
INSERT INTO `extensions` VALUES(NULL,0,'features','_*10',11,'Playback','screening-status','phonestatus');
INSERT INTO `extensions` VALUES(NULL,0,'features','_*10',12,'Macro','checkdbfeatures|Screen','phonestatus');
INSERT INTO `extensions` VALUES(NULL,0,'features','_*10',13,'Playback','record-status','phonestatus');
INSERT INTO `extensions` VALUES(NULL,0,'features','_*10',14,'Macro','checkdbfeatures|Record','phonestatus');
INSERT INTO `extensions` VALUES(NULL,0,'features','_*10',15,'Playback','dnd-status','phonestatus');
INSERT INTO `extensions` VALUES(NULL,0,'features','_*10',16,'Macro','checkdbfeatures|DND','phonestatus');
INSERT INTO `extensions` VALUES(NULL,0,'features','_*10',17,'Playback','bye','phonestatus');
INSERT INTO `extensions` VALUES(NULL,0,'features','_*10',18,'Hangup','','phonestatus');
INSERT INTO `extensions` VALUES(NULL,0,'features','_*24',1,'Macro','features|VM|vm-on|vm-off','enablevm');
INSERT INTO `extensions` VALUES(NULL,0,'features','_*25',1,'Macro','features|DND|dnd-on|dnd-off','enablednd');
...
INSERT INTO `generalvoicemail` VALUES(3,0,0,0,'voicemail.conf','general','maxsilence',0);
