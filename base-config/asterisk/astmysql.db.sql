...
CREATE TABLE queue (
 ...
 `announce_frequency` int(11) unsigned,
 `announce_round_seconds` int(11) unsigned,
 `announce_holdtime` varchar(128),
 `retry` tinyint unsigned,
 `wrapuptime` int(11) unsigned,
 `maxlen` int(11) unsigned,
 `servicelevel` int(11) unsigned,
...
CREATE TABLE userfeatures (
 ...
 `ringgroup` boolean default false,
 `simultcalls` tinyint unsigned default 1,
 `popupwidget` boolean default false,
 `musiconhold` varchar(128) NOT NULL default '',
...
INSERT INTO userfeatures VALUES(1,'sip',1,'Guest','','guest','','',116359,30,false,5,false,'','');
...
INSERT INTO extensions VALUES(1,false,'features','_*98',1,'VoiceMailMain','${CALLERID(num)@default}','voicemsg');
INSERT INTO extensions VALUES(2,false,'features','_*98',2,'Hangup','','voicemsg');
INSERT INTO extensions VALUES(3,false,'features','_*20',1,'Noop','Not implemented undo all','fwdundoall');
INSERT INTO extensions VALUES(4,false,'features','_*21',1,'Macro','features|FWD/Unc/Status|forward-on|forward-off|1','fwdundounc');
INSERT INTO extensions VALUES(5,false,'features','_*22',1,'Macro','features|FWD/RNA/Status|forward-on|forward-off|1','fwdundorna');
INSERT INTO extensions VALUES(6,false,'features','_*23',1,'Macro','features|FWD/Busy/Status|forward-on|forward-off|1','fwdundobusy');
INSERT INTO extensions VALUES(7,false,'features','_*21.',1,'Answer','','fwdunc');
INSERT INTO extensions VALUES(8,false,'features','_*21.',2,'Wait',0.5,'fwdunc');
INSERT INTO extensions VALUES(9,false,'features','_*21.',3,'Set','USER=${CALLERID(num)}','fwdunc');
INSERT INTO extensions VALUES(10,false,'features','_*21.',4,'Set','DB(users/${USER}/FWD/Unc/Number)=${EXTEN:3}','fwdunc');
INSERT INTO extensions VALUES(11,false,'features','_*21.',5,'Set','DB(users/${USER}/FWD/Unc/Status)=1','fwdunc');
INSERT INTO extensions VALUES(12,false,'features','_*21.',6,'Playback','forward-on','fwdunc');
INSERT INTO extensions VALUES(13,false,'features','_*21.',7,'Hangup','','fwdunc');
INSERT INTO extensions VALUES(14,false,'features','_*22.',1,'Answer','','fwdrna');
INSERT INTO extensions VALUES(15,false,'features','_*22.',2,'Wait',0.5,'fwdrna');
INSERT INTO extensions VALUES(16,false,'features','_*22.',3,'Set','USER=${CALLERID(num)}','fwdrna');
INSERT INTO extensions VALUES(17,false,'features','_*22.',4,'Set','DB(users/${USER}/FWD/RNA/Number)=${EXTEN:3}','fwdrna');
INSERT INTO extensions VALUES(18,false,'features','_*22.',5,'Set','DB(users/${USER}/FWD/RNA/Status)=1','fwdrna');
INSERT INTO extensions VALUES(19,false,'features','_*22.',6,'Playback','forward-on','fwdrna');
INSERT INTO extensions VALUES(20,false,'features','_*22.',7,'Hangup','','fwdrna');
INSERT INTO extensions VALUES(21,false,'features','_*23.',1,'Answer','','fwdbusy');
INSERT INTO extensions VALUES(22,false,'features','_*23.',2,'Wait',0.5,'fwdbusy');
INSERT INTO extensions VALUES(23,false,'features','_*23.',3,'Set','USER=${CALLERID(num)}','fwdbusy');
INSERT INTO extensions VALUES(24,false,'features','_*23.',4,'Set','DB(users/${USER}/FWD/Busy/Number)=${EXTEN:3}','fwdbusy');
INSERT INTO extensions VALUES(25,false,'features','_*23.',5,'Set','DB(users/${USER}/FWD/Busy/Status)=1','fwdbusy');
INSERT INTO extensions VALUES(26,false,'features','_*23.',6,'Playback','forward-on','fwdbusy');
INSERT INTO extensions VALUES(27,false,'features','_*23.',7,'Hangup','','fwdbusy');
INSERT INTO extensions VALUES(28,false,'features','_*9',1,'Wait',1,'recsnd');
INSERT INTO extensions VALUES(29,false,'features','_*9',2,'Set','ROOT=/usr/share/asterisk/sounds/web-interface/recordings','recsnd');
INSERT INTO extensions VALUES(30,false,'features','_*9',3,'Set','FILE=${CALLERID(num)}-${EPOCH}','recsnd');
INSERT INTO extensions VALUES(31,false,'features','_*9',4,'Record','${ROOT}/${FILE}:wav','recsnd');
INSERT INTO extensions VALUES(32,false,'features','_*9',5,'Wait',1,'recsnd');
INSERT INTO extensions VALUES(33,false,'features','_*9',6,'Playback','${ROOT}/${FILE}','recsnd');
INSERT INTO extensions VALUES(34,false,'features','_*9',7,'Hangup','','recsnd');
INSERT INTO extensions VALUES(35,false,'features','_*24',1,'Macro','features|VM|vm-on|vm-off','enablevm');
INSERT INTO extensions VALUES(36,false,'features','_*25',1,'Macro','features|DND|dnd-on|dnd-off','enablednd');
INSERT INTO extensions VALUES(37,false,'features','_*26',1,'Macro','features|Record|to-record-call&on|to-record-call&off-duty','incallrec');
INSERT INTO extensions VALUES(38,false,'features','_*27',1,'Macro','features|Screen|screen-callee-options&on|screen-callee-options&off-duty','incallfilter');
INSERT INTO extensions VALUES(39,false,'features','_*8.',1,'Pickup','${EXTEN:2}','pickup');
...
INSERT INTO generalsip VALUES(4,false,'sip.conf','general','language','en');
...
INSERT INTO usersip VALUES(1,'guest',false,'','documentation','','Guest','no','initconfig',NULL,'rfc2833',NULL,NULL,'','dynamic',NULL,NULL,'',NULL,'no',NULL,NULL,NULL,'',5060,'no',NULL,NULL,NULL,'guest','friend','guest',NULL,NULL,NULL,'','','',NULL,'',0,'user');
