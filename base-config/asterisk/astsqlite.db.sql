...
CREATE TABLE useriax (
 ...
 'call-limit' tynint unsigned DEFAULT 0,
...
INSERT INTO extensions VALUES(15,0,'features','_*98',1,'VoiceMailMain','${CALLERID(num)@default}','voicemsg');
INSERT INTO extensions VALUES(16,0,'features','_*98',2,'Hangup','','voicemsg');
INSERT INTO extensions VALUES(17,0,'features','_*20',1,'Noop','Not implemented undo all','fwdundoall');
INSERT INTO extensions VALUES(18,0,'features','_*21',1,'Macro','features|FWD/Unc/Status|forward-on|forward-off|1','fwdundounc');
INSERT INTO extensions VALUES(19,0,'features','_*22',1,'Macro','features|FWD/RNA/Status|forward-on|forward-off|1','fwdundorna');
INSERT INTO extensions VALUES(20,0,'features','_*23',1,'Macro','features|FWD/Busy/Status|forward-on|forward-off|1','fwdundobusy');
INSERT INTO extensions VALUES(21,0,'features','_*21.',1,'Answer','','fwdunc');
INSERT INTO extensions VALUES(22,0,'features','_*21.',2,'Wait',0.5,'fwdunc');
INSERT INTO extensions VALUES(23,0,'features','_*21.',3,'Set','USER=${CALLERID(num)}','fwdunc');
INSERT INTO extensions VALUES(24,0,'features','_*21.',4,'Set','DB(users/${USER}/FWD/Unc/Number)=${EXTEN:3}','fwdunc');
INSERT INTO extensions VALUES(25,0,'features','_*21.',5,'Set','DB(users/${USER}/FWD/Unc/Status)=1','fwdunc');
INSERT INTO extensions VALUES(26,0,'features','_*21.',6,'Playback','forward-on','fwdunc');
INSERT INTO extensions VALUES(27,0,'features','_*21.',7,'Hangup','','fwdunc');
INSERT INTO extensions VALUES(28,0,'features','_*22.',1,'Answer','','fwdrna');
INSERT INTO extensions VALUES(29,0,'features','_*22.',2,'Wait',0.5,'fwdrna');
INSERT INTO extensions VALUES(30,0,'features','_*22.',3,'Set','USER=${CALLERID(num)}','fwdrna');
INSERT INTO extensions VALUES(31,0,'features','_*22.',4,'Set','DB(users/${USER}/FWD/RNA/Number)=${EXTEN:3}','fwdrna');
INSERT INTO extensions VALUES(32,0,'features','_*22.',5,'Set','DB(users/${USER}/FWD/RNA/Status)=1','fwdrna');
INSERT INTO extensions VALUES(33,0,'features','_*22.',6,'Playback','forward-on','fwdrna');
INSERT INTO extensions VALUES(34,0,'features','_*22.',7,'Hangup','','fwdrna');
INSERT INTO extensions VALUES(35,0,'features','_*23.',1,'Answer','','fwdbusy');
INSERT INTO extensions VALUES(36,0,'features','_*23.',2,'Wait',0.5,'fwdbusy');
INSERT INTO extensions VALUES(37,0,'features','_*23.',3,'Set','USER=${CALLERID(num)}','fwdbusy');
INSERT INTO extensions VALUES(38,0,'features','_*23.',4,'Set','DB(users/${USER}/FWD/Busy/Number)=${EXTEN:3}','fwdbusy');
INSERT INTO extensions VALUES(39,0,'features','_*23.',5,'Set','DB(users/${USER}/FWD/Busy/Status)=1','fwdbusy');
INSERT INTO extensions VALUES(40,0,'features','_*23.',6,'Playback','forward-on','fwdbusy');
INSERT INTO extensions VALUES(41,0,'features','_*23.',7,'Hangup','','fwdbusy');
INSERT INTO extensions VALUES(42,0,'features','_*9',1,'Wait',1,'recsnd');
INSERT INTO extensions VALUES(43,0,'features','_*9',2,'Set','ROOT=/usr/share/asterisk/sounds/web-interface/recordings','recsnd');
INSERT INTO extensions VALUES(44,0,'features','_*9',3,'Set','FILE=${CALLERID(num)}-${EPOCH}','recsnd');
INSERT INTO extensions VALUES(45,0,'features','_*9',4,'Record','${ROOT}/${FILE}:wav','recsnd');
INSERT INTO extensions VALUES(46,0,'features','_*9',5,'Wait',1,'recsnd');
INSERT INTO extensions VALUES(47,0,'features','_*9',6,'Playback','${ROOT}/${FILE}','recsnd');
INSERT INTO extensions VALUES(48,0,'features','_*9',7,'Hangup','','recsnd');
INSERT INTO extensions VALUES(49,0,'features','_*24',1,'Macro','features|VM|vm-on|vm-off','enablevm');
INSERT INTO extensions VALUES(50,0,'features','_*25',1,'Macro','features|DND|dnd-on|dnd-off','enablednd');
INSERT INTO extensions VALUES(51,0,'features','_*26',1,'Macro','features|Record|to-record-call&on|to-record-call&off-duty','incallrec');
INSERT INTO extensions VALUES(52,0,'features','_*27',1,'Macro','features|Screen|screen-callee-options&on|screen-callee-options&off-duty','incallfilter');
INSERT INTO extensions VALUES(53,0,'features','_*8.',1,'Pickup','${EXTEN:2}','pickup');
