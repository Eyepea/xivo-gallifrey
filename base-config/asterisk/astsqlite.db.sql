...
INSERT INTO ctisheetactions VALUES(6,'dial','','["default"]','dest','["1","2","3"]','{"10": [ "","text","Inconnu","Appel {xivo-direction} de {xivo-calleridnum}" ],"20": [ "Numéro entrant","phone","Inconnu","{xivo_calleridnum}" ],"30": [ "Nom","text","Inconnu","{db-fullname}" ],"40": [ "Numéro appelé","phone","Inconnu","{xivo-calledidnum}" ]}','{"10": [ "","title","","Appel {xivo-direction}" ],"20": [ "","body","Inconnu","appel de {xivo-calleridnum} pour {xivo-calledidnum}" ],"30": [ "","body","Inconnu","{db-fullname} (selon {xivo-dir})" ],"40": [ "","body","","le {xivo-date}, il est {xivo-time}" ]}','','{"10": [ "","urlauto","","http://www.google.fr/search?q={xivo-calleridnum}" ]}','',1);
INSERT INTO ctisheetactions VALUES(7,'queue','','["default"]','dest','["1","2","3"]','{"10": [ "","text","Inconnu","Appel {xivo-direction} de la File {xivo-queuename}" ],"20": [ "Numéro entrant","phone","Inconnu","{xivo_calleridnum}" ],"30": [ "Nom","text","Inconnu","{db-fullname}" ]}','{"10": [ "","title","","Appel {xivo-direction} de la File {xivo-queuename}" ],"20": [ "","body","Inconnu","appel de {xivo-calleridnum} pour {xivo-calledidnum}" ],"30": [ "","body","Inconnu","{db-fullname} (selon {xivo-dir})" ],"40": [ "","body","","le {xivo-date}, il est {xivo-time}" ]}','file:///etc/pf-xivo/ctiservers/form.ui','{}','',1);
INSERT INTO ctisheetactions VALUES(8,'custom1','','["default"]','all','["1","2","3"]','{"10": [ "","text","Inconnu","Appel {xivo-direction} (Custom)" ],"20": [ "Numéro entrant","phone","Inconnu","{xivo_calleridnum}" ],"30": [ "Nom","text","Inconnu","{db-fullname}" ]}','{"10": [ "","title","","Appel {xivo-direction} (Custom)" ],"20": [ "","body","Inconnu","appel de {xivo-calleridnum} pour {xivo-calledidnum}" ],"30": [ "","body","Inconnu","{db-fullname} (selon {xivo-dir})" ],"40": [ "","body","","le {xivo-date}, il est {xivo-time}" ]}','','{}','',1);
...
INSERT INTO staticsccp VALUES(37,0,0,0,'sccp.conf','general','dateFormat','D.M.Y');
INSERT INTO staticsccp VALUES(38,0,0,0,'sccp.conf','general','bindaddr','0.0.0.0');
INSERT INTO staticsccp VALUES(39,0,0,0,'sccp.conf','general','port',2000);
INSERT INTO staticsccp VALUES(40,0,0,1,'sccp.conf','general','allow',NULL);
INSERT INTO staticsccp VALUES(41,0,0,0,'sccp.conf','general','firstdigittimeout',16);
INSERT INTO staticsccp VALUES(42,0,0,0,'sccp.conf','general','digittimeout',8);
INSERT INTO staticsccp VALUES(43,0,0,0,'sccp.conf','general','digittimeoutchar','#');
INSERT INTO staticsccp VALUES(44,0,0,0,'sccp.conf','general','autoanswer_ring_time',0);
INSERT INTO staticsccp VALUES(45,0,0,0,'sccp.conf','general','autoanswer_tone','0x32');
INSERT INTO staticsccp VALUES(46,0,0,0,'sccp.conf','general','remotehangup_tone','0x32');
INSERT INTO staticsccp VALUES(47,0,0,0,'sccp.conf','general','transfer_tone',0);
INSERT INTO staticsccp VALUES(48,0,0,0,'sccp.conf','general','callwaiting_tone','0x2d');
INSERT INTO staticsccp VALUES(49,0,0,0,'sccp.conf','general','musicclass','default');
INSERT INTO staticsccp VALUES(50,0,0,0,'sccp.conf','general','callevents','no');
INSERT INTO staticsccp VALUES(51,0,0,0,'sccp.conf','general','accountcode','skinny');
INSERT INTO staticsccp VALUES(52,0,0,0,'sccp.conf','general','deny','0.0.0.0/0.0.0.0');
INSERT INTO staticsccp VALUES(53,0,0,0,'sccp.conf','general','permit','0.0.0.0/255.255.255.0');
INSERT INTO staticsccp VALUES(54,0,0,0,'sccp.conf','general','localnet','192.168.1.0/255.255.255.0');
INSERT INTO staticsccp VALUES(55,0,0,0,'sccp.conf','general','externip','1.2.3.4');
INSERT INTO staticsccp VALUES(56,0,0,0,'sccp.conf','general','externhost','mydomain.dyndns.org');
INSERT INTO staticsccp VALUES(57,0,0,0,'sccp.conf','general','dnd','off');
INSERT INTO staticsccp VALUES(58,0,0,0,'sccp.conf','general','sccp_tos','0x68');
INSERT INTO staticsccp VALUES(59,0,0,0,'sccp.conf','general','sccp_cos',4);
INSERT INTO staticsccp VALUES(60,0,0,0,'sccp.conf','general','audio_tos','0xB8');
INSERT INTO staticsccp VALUES(61,0,0,0,'sccp.conf','general','audio_cos',6);
INSERT INTO staticsccp VALUES(62,0,0,0,'sccp.conf','general','video_tos','0x88');
INSERT INTO staticsccp VALUES(63,0,0,0,'sccp.conf','general','video_cos',5);
INSERT INTO staticsccp VALUES(64,0,0,0,'sccp.conf','general','echocancel','on');
INSERT INTO staticsccp VALUES(65,0,0,0,'sccp.conf','general','silencesuppression','off');
INSERT INTO staticsccp VALUES(66,0,0,0,'sccp.conf','general','callgroup','1,3-4');
INSERT INTO staticsccp VALUES(67,0,0,0,'sccp.conf','general','pickupgroup','1,3-5');
INSERT INTO staticsccp VALUES(68,0,0,1,'sccp.conf','general','amaflags',NULL);
INSERT INTO staticsccp VALUES(69,0,0,0,'sccp.conf','general','trustphoneip','no');
INSERT INTO staticsccp VALUES(70,0,0,0,'sccp.conf','general','earlyrtp','none');
INSERT INTO staticsccp VALUES(71,0,0,0,'sccp.conf','general','private','on');
INSERT INTO staticsccp VALUES(72,0,0,0,'sccp.conf','general','mwilamp','on');
INSERT INTO staticsccp VALUES(73,0,0,0,'sccp.conf','general','mwioncall','off');
INSERT INTO staticsccp VALUES(74,0,0,0,'sccp.conf','general','blindtransferindication','ring');
INSERT INTO staticsccp VALUES(75,0,0,0,'sccp.conf','general','protocolversion',11);
INSERT INTO staticsccp VALUES(76,0,0,0,'sccp.conf','general','cfwdall','off');
INSERT INTO staticsccp VALUES(77,0,0,0,'sccp.conf','general','cfwdbusy','off');
INSERT INTO staticsccp VALUES(78,0,0,0,'sccp.conf','general','cfwdnoanswer','off');
INSERT INTO staticsccp VALUES(79,0,0,0,'sccp.conf','general','devicetable','sccpdevice');
INSERT INTO staticsccp VALUES(80,0,0,0,'sccp.conf','general','linetable','sccpline');
INSERT INTO staticsccp VALUES(81,0,0,0,'sccp.conf','general','directrtp','off');
INSERT INTO staticsccp VALUES(82,0,0,0,'sccp.conf','general','allowoverlap','off');
INSERT INTO staticsccp VALUES(83,0,0,0,'sccp.conf','general','callanswerorder','olderfirst');
INSERT INTO staticsccp VALUES(84,0,0,0,'sccp.conf','general','jbenable','no');
INSERT INTO staticsccp VALUES(85,0,0,0,'sccp.conf','general','jbforce','no');
INSERT INTO staticsccp VALUES(86,0,0,0,'sccp.conf','general','jbmaxsize',200);
INSERT INTO staticsccp VALUES(87,0,0,0,'sccp.conf','general','jbresyncthreshold',1000);
INSERT INTO staticsccp VALUES(88,0,0,0,'sccp.conf','general','jbimpl','fixed');
INSERT INTO staticsccp VALUES(89,0,0,0,'sccp.conf','general','jblog','no');
INSERT INTO staticsccp VALUES(90,0,0,0,'sccp.conf','general','hotline_enabled','yes');
INSERT INTO staticsccp VALUES(91,0,0,0,'sccp.conf','general','hotline_context','default');
INSERT INTO staticsccp VALUES(92,0,0,0,'sccp.conf','general','hotline_extension',111);
INSERT INTO staticsccp VALUES(93,0,0,0,'sccp.conf','general','context','sccp');
INSERT INTO staticsccp VALUES(94,0,0,0,'sccp.conf','general','disallow','all');
INSERT INTO staticsccp VALUES(95,0,0,0,'sccp.conf','general','externrefresh',60);
INSERT INTO staticsccp VALUES(96,0,0,0,'sccp.conf','general','language','fr');
INSERT INTO staticsccp VALUES(97,0,0,0,'sccp.conf','general','nat','off');
