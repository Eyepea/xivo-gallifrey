      ...
      data_files=[
            ('/usr/share/pf-xivo-provisioning/files',
                ['files/aastra-6730i.cfg',
                 ...
                 'files/ciscosmb-spa501g.cfg',
                 'files/ciscosmb-spa502g.cfg',
                 'files/ciscosmb-spa504g.cfg',
                 'files/ciscosmb-spa508g.cfg',
                 'files/ciscosmb-spa509g.cfg',
                 'files/ciscosmb-spa525g.cfg',
                 'files/ciscosmb-spa525g2.cfg',
                 ...
                 'files/nortel-12x0.cfg',
                 'files/polycom-user.cfg',
                 'files/sccp-cisco-addons.cfg',
                 'files/sccp-cisco-cipc.cfg',
                 'files/sccp-cisco-cp7906g.cfg',
                 'files/sccp-cisco-cp7911g.cfg',
                 'files/sccp-cisco-cp7912g.cfg',
                 'files/sccp-cisco-cp7931g.cfg',
                 'files/sccp-cisco-cp7940g.cfg',
                 'files/sccp-cisco-cp7941g.cfg',
                 'files/sccp-cisco-cp7942g.cfg',
                 'files/sccp-cisco-cp7945g.cfg',
                 'files/sccp-cisco-cp7960g.cfg',
                 'files/sccp-cisco-cp7961g.cfg',
                 'files/sccp-cisco-cp7962g.cfg',
                 'files/sccp-cisco-cp7965g.cfg',
                 'files/sccp-cisco-cp7970g.cfg',
                 'files/sccp-cisco-cp7971g.cfg',
                 'files/sccp-cisco-cp7975g.cfg',
