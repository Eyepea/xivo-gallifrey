	...
	case 'add':
		...
		&& dwho_issa('contexts',$_QR) === true)
		{
			...
			|| $app->add() === false)
			{
				...
				$_QRY->go($_TPL->url('service/ipbx/cti_settings/contexts'),$param);
		}
...
$menu->set_toolbar('toolbar/service/ipbx/'.$ipbx->get_name().'/cti_settings/contexts');

$_TPL->set_bloc('main','service/ipbx/'.$ipbx->get_name().'/cti_settings/contexts/'.$act);
