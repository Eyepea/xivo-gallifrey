	...
	case 'add':
		...
		&& dwho_issa('displays',$_QR) === true)
		{
			...
			|| $app->add() === false)
			{
				...
				$_QRY->go($_TPL->url('service/ipbx/cti_settings/displays'),$param);
		}
...
$menu->set_toolbar('toolbar/service/ipbx/'.$ipbx->get_name().'/cti_settings/displays');

$_TPL->set_bloc('main','service/ipbx/'.$ipbx->get_name().'/cti_settings/displays/'.$act);
