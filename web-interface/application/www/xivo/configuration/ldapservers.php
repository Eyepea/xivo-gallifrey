	...
	case 'add':
		...
		if(isset($_QR['fm_send']) === true)
		{
			if(($result = $_LDAPSVR->chk_values($_QR)) === false)
				...
				$_QRY->go($_HTML->url('xivo/configuration/ldapservers'),$param);
		}
...
$menu->set_toolbar('toolbar/xivo/configuration/ldapservers');

$_HTML->set_bloc('main','xivo/configuration/ldapservers/'.$act);
