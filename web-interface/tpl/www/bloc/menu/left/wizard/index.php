...
<dl>
	...
	<dd>
		<dl>
			...
			<dd id="mn-wizard--lang"><?=$this->bbf('mn_left_wizard-lang');?></dd>
			...
			<dd id="mn-wizard--check"><?=$this->bbf('mn_left_wizard-check');?></dd>
			<dd id="mn-wizard--adminsetup"><?=$this->bbf('mn_left_wizard-adminsetup');?></dd>
			<dd id="mn-wizard--entctx"><?=$this->bbf('mn_left_wizard-entctx');?></dd>
