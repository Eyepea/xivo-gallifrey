...
<div class="sb-advanced-menu">
	<ul id="advanced-menu" onmouseover="this.style.display = 'block';" onmouseout="this.style.display = 'none';">	
		...
		<li><a href="#" onclick="this.tmp = xivo_fm['fm-rightcall-list']['act'].value; xivo_fm['fm-rightcall-list']['act'].value = 'deletes'; return(confirm('<?=$dhtml->escape($this->bbf('toolbar_adv_menu_delete_confirm'));?>') ? xivo_fm['fm-rightcall-list'].submit() : xivo_fm['fm-rightcall-list']['act'] = this.tmp);"><?=$this->bbf('toolbar_adv_menu_delete');?></a></li>
	</ul>
</div>
<?php
	endif;
