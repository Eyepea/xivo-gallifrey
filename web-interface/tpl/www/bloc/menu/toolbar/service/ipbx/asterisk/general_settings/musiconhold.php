...
<?=$form->hidden(array('name' => 'act','value' => 'list'));?>
	<div class="fm-field"><?=$form->slt(array('name' => 'cat','id' => 'it-cat','key' => true,'key_val' => 'category','field' => false,'empty' => $this->bbf('toolbar_fm_category-main'),'value' => $this->vars('cat')),$this->vars('list_cats'),($act !== 'list' && $act !== 'listfile' ? 'onmouseover="xivo_fm_unshift_pop_opt_select(this.id);"' : '').'onchange="this.form[\'act\'].value = this.value == \'\' ? \'list\' : \'listfile\'; return(this.value != \'null\' ? this.form.submit() : false);"')?></div>
</form>
