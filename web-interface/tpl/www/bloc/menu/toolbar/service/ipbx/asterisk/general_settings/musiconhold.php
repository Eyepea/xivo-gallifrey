...
<?=$form->hidden(array('name' => 'act','value' => 'list'));?>
	<div class="fm-field"><?=$form->slt(array('name' => 'cat','id' => 'it-cat','key' => true,'key_val' => 'category','field' => false,'empty' => $this->bbf('toolbar_fm_category'),'value' => $cat),$this->vars('list_cats'),'onchange="this.form[\'act\'].value = this.value == \'\' ? \'list\' : \'listfile\'; return(this.form.submit());"');?></div>
</form>
