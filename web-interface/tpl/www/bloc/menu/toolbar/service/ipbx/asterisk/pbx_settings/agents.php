...
<?=$form->hidden(array('name' => 'act','value' => 'list'));?>
	<div class="fm-field"><?=$form->slt(array('name' => 'group','id' => 'it-group','key' => true,'overkey' => 'group','browse' => 'agroup','key' => 'name','overkey' => 'id','field' => false,'empty' => $this->bbf('toolbar_fm_group'),'value' => $group),$this->vars('list_grps'),'onchange="this.form[\'act\'].value = this.value == \'\' ? \'list\' : \'listagent\'; return(this.form.submit());"');?></div>
</form>
