...
<div class="sb-advanced-menu">
	<ul id="advanced-menu"
		...
		<li>
			<a href="#"
			   onclick="xivo_fm['fm-queue-list']['act'].value = 'enables';
				    xivo_fm['fm-queue-list'].submit();">
				<?=$this->bbf('toolbar_adv_menu_enable');?></a>
		</li>
		<li>
			<a href="#"
			   onclick="xivo_fm['fm-queue-list']['act'].value = 'disables';
				    xivo_fm['fm-queue-list'].submit();">
				<?=$this->bbf('toolbar_adv_menu_disable');?></a>
		</li>
		<li>
			<a href="#"
			   onclick="this.tmp = xivo_fm['fm-queue-list']['act'].value;
				    xivo_fm['fm-queue-list']['act'].value = 'deletes';
				    return(confirm('<?=$dhtml->escape($this->bbf('toolbar_adv_menu_delete_confirm'));?>')
					   ? xivo_fm['fm-queue-list'].submit()
					   : xivo_fm['fm-queue-list']['act'] = this.tmp);">
