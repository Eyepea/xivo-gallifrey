...
<?=$form->select(array('desc' => $this->bbf('fm_outcall_mode'),'name' => 'outcall[mode]','labelid' => 'outcall-mode','key' => false,'bbf' => array('concatkey','fm_outcall_mode-opt-'),'default' => $element['outcall']['mode']['default'],'value' => ''),$element['outcall']['mode']['value'],'onchange="xivo_chgmode(this); (this.value == \'wizard\' ? xivo_exten_wizard(\'it-outcall-prefix\',\'it-outcall-numlen\',\'it-extenumbers-exten\') : xivo_wizard_exten(\'it-outcall-prefix\',\'it-outcall-numlen\',\'it-extenumbers-exten\'));" onfocus="xivo_fm_set_onfocus(this);" onblur="xivo_fm_set_onblur(this);"');?>

<?=$form->text(array('desc' => $this->bbf('fm_outcall_prefix'),'name' => 'outcall[prefix]','labelid' => 'outcall-prefix','size' => 15,'default' => $element['outcall']['prefix']['default'],'value' => ''),'onchange="xivo_wizard_exten(this.id,\'it-outcall-numlen\',\'it-extenumbers-exten\');" onfocus="xivo_wizard_exten(this.id,\'it-outcall-numlen\',\'it-extenumbers-exten\'); xivo_fm_set_onfocus(this);" onblur="xivo_wizard_exten(this.id,\'it-outcall-numlen\',\'it-extenumbers-exten\'); xivo_fm_set_onblur(this);"');?>

<?=$form->select(array('desc' => $this->bbf('fm_outcall_numlen'),'name' => 'outcall[numlen]','labelid' => 'outcall-numlen','key' => false,'empty' => true,'default' => $element['outcall']['numlen']['default'],'value' => ''),$element['outcall']['numlen']['value'],'onchange="xivo_wizard_exten(\'it-outcall-prefix\',this.id,\'it-extenumbers-exten\');" onfocus="xivo_wizard_exten(\'it-outcall-prefix\',this.id,\'it-extenumbers-exten\'); xivo_fm_set_onfocus(this);" onblur="xivo_wizard_exten(\'it-outcall-prefix\',this.id,\'it-extenumbers-exten\'); xivo_fm_set_onblur(this);"');?>
