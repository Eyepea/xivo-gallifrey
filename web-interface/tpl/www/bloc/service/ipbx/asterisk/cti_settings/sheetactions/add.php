    ...
    <div class="sb-smenu">
        <ul>
            ...
            <li id="dwsm-tab-2"
                ...
                <div class="tab">
                    <span class="span-center">
                        <a href="#" onclick="return(false);"><?=$this->bbf('smenu_screens');?></a>
                    </span>
                </div>
                <span class="span-right">&nbsp;</span>
            </li>
           <li id="dwsm-tab-3"
                ...
                <div class="tab">
                    <span class="span-center">
                        <a href="#" onclick="return(false);"><?=$this->bbf('smenu_systrays');?></a>
                    </span>
                </div>
                <span class="span-right">&nbsp;</span>
            </li>
            <li id="dwsm-tab-4"
                ...
                <div class="tab">
                    <span class="span-center">
                        <a href="#" onclick="return(false);"><?=$this->bbf('smenu_infos');?></a>
                    </span>
                </div>
                <span class="span-right">&nbsp;</span>
            </li>
...
<?php
	$this->file_include('bloc/service/ipbx/asterisk/cti_settings/sheetactions/form');
?>
