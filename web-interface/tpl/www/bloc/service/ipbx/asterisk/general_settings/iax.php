...
<?php
	echo	$form->checkbox(array('desc'	=> $this->bbf('fm_jitterbuffer'),
		...
		$form->select(array('desc'	=> $this->bbf('fm_maxjitterbuffer'),
				    ...
				    'key'	=> false,
				    'bbf'	=> array('paramkey','fm_maxjitterbuffer-opt'),
		...
		$form->select(array('desc'	=> $this->bbf('fm_maxjitterinterps'),
				    ...
				    'key'	=> false,
				    'bbf'	=> array('paramkey','fm_maxjitterinterps-opt'),
		...
		$form->select(array('desc'	=> $this->bbf('fm_resyncthreshold'),
				    ...
				    'key'	=> false,
				    'bbf'	=> array('paramkey','fm_resyncthreshold-opt'),
...
<?php
	echo	$form->text(array('desc'	=> $this->bbf('fm_accountcode'),
		...
		$form->select(array('desc'	=> $this->bbf('fm_transfer'),
				    ...
				    'labelid'	=> 'transfer',
				    'key'	=> false,
				    'bbf'	=> array('paramkey','fm_transfer-opt'),
...
if($moh_list !== false):
	...
	echo	$form->select(array('desc'	=> $this->bbf('fm_encryption'),
				    ...
				    'labelid'	=> 'encryption',
				    'key'	=> false,
				    'bbf'	=> array('paramkey','fm_encryption-opt'),
		...
		$form->select(array('desc'	=> $this->bbf('fm_maxauthreq'),
				    ...
				    'labelid'	=> 'maxauthreq',
				    'key'	=> false,
				    'bbf'	=> array('paramkey','fm_maxauthreq-opt'),
		...
		$form->select(array('desc'	=> $this->bbf('fm_codecpriority'),
				    ...
				    'key'	=> false,
				    'bbf'	=> array('paramkey','fm_codecpriority-opt'),
...
<?php
	echo	$form->select(array('desc'	=> $this->bbf('fm_pingtime'),
				    'name'	=> 'pingtime',
				    'labelid'	=> 'pingtime',
				    'bbf'	=> array('paramkey','fm_pingtime-opt'),
				    'key'	=> false,
		...
		$form->select(array('desc'	=> $this->bbf('fm_lagrqtime'),
				    'name'	=> 'lagrqtime',
				    'labelid'	=> 'lagrqtime',
				    'bbf'	=> array('paramkey','fm_lagrqtime-opt'),
				    'key'	=> false,
		...
		$form->select(array('desc'	=> $this->bbf('fm_autokill'),
				    ...
				    'labelid'	=> 'autokill',
				    'key'	=> false,
				    'bbf'	=> array('paramkey','fm_autokill-opt'),
