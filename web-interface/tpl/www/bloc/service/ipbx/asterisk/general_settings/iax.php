...
<?=$form->select(array('desc' => $this->bbf('fm_bandwidth'),'name' => 'bandwidth','labelid' => 'bandwidth','key' => false,'bbf' => array('concatvalue','fm_bandwidth-opt-'),'value' => $this->varra('info','bandwidth'),'default' => $element['bandwidth']['default']),$element['bandwidth']['value'],'onfocus="this.className=\'it-mfocus\';" onblur="this.className=\'it-mblur\';"');?>
...
<?=$form->select(array('desc' => $this->bbf('fm_dropcount'),'name' => 'dropcount','labelid' => 'dropcount','key' => false,'value' => xivo_cast_except($this->varra('info','dropcount'),null,'uint'),'default' => $element['dropcount']['default']),$element['dropcount']['value'],'onfocus="this.className=\'it-mfocus\';" onblur="this.className=\'it-mblur\';"');?>
...
<?=$form->select(array('desc' => $this->bbf('fm_amaflags'),'name' => 'amaflags','labelid' => 'amaflags','key' => false,'bbf' => array('concatvalue','fm_amaflags-opt-'),'value' => $this->varra('info','amaflags'),'default' => $element['amaflags']['default']),$element['amaflags']['value'],'onfocus="this.className=\'it-mfocus\';" onblur="this.className=\'it-mblur\';"');?>
...
<?=$form->select(array('desc' => $this->bbf('fm_encryption'),'name' => 'encryption','labelid' => 'encryption','key' => false,'bbf' => array('concatvalue','fm_encryption-opt-'),'value' => $this->varra('info','encryption'),'default' => $element['encryption']['default']),$element['encryption']['value'],'onfocus="this.className=\'it-mfocus\';" onblur="this.className=\'it-mblur\';"');?>
...
<?=$form->select(array('desc' => $this->bbf('fm_pingtime'),'name' => 'pingtime','labelid' => 'pingtime','bbf' => array('mixkey','fm_pingtime-opt'),'key' => false,'value' => xivo_cast_except($this->varra('info','pingtime'),null,'uint'),'default' => $element['pingtime']['default']),$element['pingtime']['value'],'onfocus="this.className=\'it-mfocus\';" onblur="this.className=\'it-mblur\';"');?>

<?=$form->select(array('desc' => $this->bbf('fm_lagrqtime'),'name' => 'lagrqtime','labelid' => 'lagrqtime','bbf' => array('mixkey','fm_lagrqtime-opt'),'key' => false,'value' => xivo_cast_except($this->varra('info','lagrqtime'),null,'uint'),'default' => $element['lagrqtime']['default']),$element['lagrqtime']['value'],'onfocus="this.className=\'it-mfocus\';" onblur="this.className=\'it-mblur\';"');?>
...
<?=$form->select(array('desc' => $this->bbf('fm_autokill'),'name' => 'autokill','labelid' => 'autokill','key' => false,'bbf' => array('mixkey','fm_autokill-opt'),'value' => $autokill,'default' => $element['autokill']['default']),$element['autokill']['value'],'onfocus="this.className=\'it-mfocus\';" onblur="this.className=\'it-mblur\';"');?>
