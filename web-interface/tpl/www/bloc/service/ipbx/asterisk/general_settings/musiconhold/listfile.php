...
?>
	<tr onmouseover="this.tmp = this.className; this.className = 'sb-content l-infos-over';" onmouseout="this.className = this.tmp;" class="sb-content l-infos-<?=$mod?>on2">
		...
		<?=$url->href_html($url->img_html('img/site/button/edit.gif',$this->bbf('opt_modify'),'border="0"'),'service/ipbx/general_settings/musiconhold',array('act' => 'editfile','cat' => $cat,'id' => $ref,'page' => $pager['page']),null,$this->bbf('opt_modify'));?>
