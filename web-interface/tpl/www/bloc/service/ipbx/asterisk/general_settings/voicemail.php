...
<?php
	...
	echo	$form->select(array('desc'	=> $this->bbf('fm_voicemail-maxmsg'),
		...
		$form->select(array('desc'	=> $this->bbf('fm_voicemail-minmessage'),
				    ...
				    'bbf'	=> array('mixkey','fm_voicemail-minmessage-opt','paramarray'),
		...
		$form->select(array('desc'	=> $this->bbf('fm_voicemail-maxmessage'),
				    ...
				    'bbf'	=> array('mixkey','fm_voicemail-maxmessage-opt','paramarray'),
		...
		$form->select(array('desc'	=> $this->bbf('fm_voicemail-maxsilence'),
				    ...
				    'bbf'	=> array('mixkey','fm_voicemail-maxsilence-opt'),
...
<div id="formatlist" class="fm-field fm-multilist">
	...
	<div class="inout-list">
		<a href="#"
		   onclick="xivo_informat(); return(xivo_free_focus());"
		...
		<a href="#"
		   onclick="xivo_outformat(); return(xivo_free_focus());"
...
if($context_list !== false):
	...
	echo	$form->checkbox(array('desc'	=> $this->bbf('fm_voicemail-sayduration'),
		...
		$form->select(array('desc'	=> $this->bbf('fm_voicemail-saydurationm'),
				    ...
				    'key'	=> false,
				    'bbf'	=> array('mixkey','fm_voicemail-saydurationm-opt'),
		...
		$form->select(array('desc'	=> $this->bbf('fm_voicemail-maxgreet'),
				    ...
				    'bbf'	=> array('mixkey','fm_voicemail-maxgreet-opt','paramarray'),
		...
		$form->select(array('desc'	=> $this->bbf('fm_voicemail-skipms'),
				    ...
				    'bbf'	=> array('mixvalue','fm_voicemail-skipms-opt'),
		...
		<tr class="sb-top">
			...
			<th class="th-right">
				<?=$url->href_html($url->img_html('img/site/button/mini/orange/bo-add.gif',
						   ...
						   '#',
						   null,
						   'onclick="xivo_table_list(\'timezone\',this); return(xivo_free_focus());"',
						   $this->bbf('col_timezone-add'));?>
			</th>
		</tr>
		</thead>
		...
		<tr class="fm-field<?=$errdisplay?>">
			...
			<td class="td-right">
				<?=$url->href_html($url->img_html('img/site/button/mini/blue/delete.gif',
						   ...
						   '#',
						   null,
						   'onclick="xivo_table_list(\'timezone\',this,1); return(xivo_free_focus());"',
						   $this->bbf('opt_delete'));?>
			</td>
		</tr>
<?php
