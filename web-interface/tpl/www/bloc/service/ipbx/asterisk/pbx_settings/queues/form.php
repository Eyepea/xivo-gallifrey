...
<?php
	echo	$form->text(array('desc'	=> $this->bbf('fm_qfeatures_name'),
				  'name'	=> 'qfeatures[name]',
				  'labelid'	=> 'qfeatures-name',
				  'size'	=> 15,
				  'default'	=> $element['qfeatures']['name']['default'],
				  'value'	=> $info['qfeatures']['name'])),

		$form->text(array('desc'	=> $this->bbf('fm_qfeatures_number'),
				  'name'	=> 'qfeatures[number]',
				  'labelid'	=> 'qfeatures-number',
				  'size'	=> 15,
				  'default'	=> $element['qfeatures']['number']['default'],
				  'value'	=> $info['qfeatures']['number'])),

		$form->select(array('desc'	=> $this->bbf('fm_queue_strategy'),
				    'name'	=> 'queue[strategy]',
				    'labelid'	=> 'queue-strategy',
				    'key'	=> false,
				    'bbf'	=> array('paramkey','fm_queue_strategy-opt'),
				    'default'	=> $element['queue']['strategy']['default'],
				    'value'	=> $info['queue']['strategy']),
			      $element['queue']['strategy']['value']);

if($context_list !== false):
	echo	$form->select(array('desc'	=> $this->bbf('fm_qfeatures_context'),
				    'name'	=> 'qfeatures[context]',
				    'labelid'	=> 'qfeatures-context',
				    'key'	=> 'identity',
				    'altkey'	=> 'name',
				    'default'	=> $element['qfeatures']['context']['default'],
				    'value'	=> $info['qfeatures']['context']),
			      $context_list);
else:
	echo	'<div id="fd-qfeatures-context" class="txt-center">',
...
<?php
	echo	$form->select(array('desc'	=> $this->bbf('fm_queue_announce-frequency'),
		...
		$form->select(array('desc'	=> $this->bbf('fm_queue_announce-holdtime'),
				    ...
				    'key'	=> false,
				    'bbf'	=> array('paramkey','fm_queue_announce-holdtime-opt'),
				    'default'	=> $element['queue']['announce-holdtime']['default'],
				    'value'	=> $info['queue']['announce-holdtime']),
		...
		$form->select(array('desc'	=> $this->bbf('fm_queue_announce-round-seconds'),
				    ...
				    'key'	=> false,
				    'bbf'	=> array('paramkey','fm_queue_announce-round-seconds-opt'),
				    'default'	=> $element['queue']['announce-round-seconds']['default'],
				    'value'	=> $info['queue']['announce-round-seconds']),
		...
		$form->select(array('desc'	=> $this->bbf('fm_queue_queue-youarenext'),
				    ...
				    'value'	=> $info['queue']['queue-youarenext']),
			      $announce_list),
		...
		$form->select(array('desc'	=> $this->bbf('fm_queue_queue-thereare'),
				    ...
				    'value'	=> $info['queue']['queue-thereare']),
			      $announce_list),
		...
		$form->select(array('desc'	=> $this->bbf('fm_queue_queue-callswaiting'),
				    ...
				    'value'	=> $info['queue']['queue-callswaiting']),
			      $announce_list),
		...
		$form->select(array('desc'	=> $this->bbf('fm_queue_queue-holdtime'),
				    ...
				    'value'	=> $info['queue']['queue-holdtime']),
			      $announce_list),
		...
		$form->select(array('desc'	=> $this->bbf('fm_queue_queue-minutes'),
				    ...
				    'value'	=> $info['queue']['queue-minutes']),
			      $announce_list),
		...
		$form->select(array('desc'	=> $this->bbf('fm_queue_queue-seconds'),
				    ...
				    'value'	=> $info['queue']['queue-seconds']),
			      $announce_list),
		...
		$form->select(array('desc'	=> $this->bbf('fm_queue_queue-thankyou'),
				    ...
				    'value'	=> $info['queue']['queue-thankyou']),
			      $announce_list),
		...
		$form->select(array('desc'	=> $this->bbf('fm_queue_queue-lessthan'),
				    ...
				    'value'	=> $info['queue']['queue-lessthan']),
			      $announce_list),
...
<?php
	echo	$form->select(array('desc'	=> $this->bbf('fm_qfeatures_timeout'),
				    'name'	=> 'qfeatures[timeout]',
				    'labelid'	=> 'qfeatures-timeout',
				    'key'	=> false,
				    'bbf'	=> 'fm_qfeatures_timeout-opt',
				    'bbf_opt'	=> array('argmode'	=> 'paramkey',
				    			 'time'		=> array(
							 		'from'		=> 'second',
							 		'format'	=> '%M%s')),
				    'default'	=> $element['qfeatures']['timeout']['default'],
				    'value'	=> $info['qfeatures']['timeout']),
			      $element['qfeatures']['timeout']['value']),

		$form->checkbox(array('desc'	=> $this->bbf('fm_qfeatures_data-quality'),
				      'name'	=> 'qfeatures[data_quality]',
				      'labelid'	=> 'qfeatures-data-quality',
				      'default'	=> $element['qfeatures']['data_quality']['default'],
				      'checked'	=> $info['qfeatures']['data_quality'])),

		$form->checkbox(array('desc'	=> $this->bbf('fm_qfeatures_hitting-callee'),
				      'name'	=> 'qfeatures[hitting_callee]',
				      'labelid'	=> 'qfeatures-hitting-callee',
				      'default'	=> $element['qfeatures']['hitting_callee']['default'],
				      'checked'	=> $info['qfeatures']['hitting_callee'])),

		$form->checkbox(array('desc'	=> $this->bbf('fm_qfeatures_hitting-caller'),
				      'name'	=> 'qfeatures[hitting_caller]',
				      'labelid'	=> 'qfeatures-hitting-caller',
				      'default'	=> $element['qfeatures']['hitting_caller']['default'],
				      'checked'	=> $info['qfeatures']['hitting_caller'])),

		$form->checkbox(array('desc'	=> $this->bbf('fm_qfeatures_retries'),
				      'name'	=> 'qfeatures[retries]',
				      'labelid'	=> 'qfeatures-retries',
				      'default'	=> $element['qfeatures']['retries']['default'],
				      'checked'	=> $info['qfeatures']['retries'])),

		$form->checkbox(array('desc'	=> $this->bbf('fm_qfeatures_ring'),
				      'name'	=> 'qfeatures[ring]',
				      'labelid'	=> 'qfeatures-ring',
				      'default'	=> $element['qfeatures']['ring']['default'],
				      'checked'	=> $info['qfeatures']['ring'])),

		$form->checkbox(array('desc'	=> $this->bbf('fm_qfeatures_transfer-user'),
				      'name'	=> 'qfeatures[transfer_user]',
				      'labelid'	=> 'qfeatures-transfer-user',
				      'default'	=> $element['qfeatures']['transfer_user']['default'],
				      'checked'	=> $info['qfeatures']['transfer_user'])),

		$form->checkbox(array('desc'	=> $this->bbf('fm_qfeatures_transfer-call'),
				      'name'	=> 'qfeatures[transfer_call]',
				      'labelid'	=> 'qfeatures-transfer-call',
				      'default'	=> $element['qfeatures']['transfer_call']['default'],
				      'checked'	=> $info['qfeatures']['transfer_call'])),

		$form->checkbox(array('desc'	=> $this->bbf('fm_qfeatures_write-caller'),
				      'name'	=> 'qfeatures[write_caller]',
				      'labelid'	=> 'qfeatures-write-caller',
				      'default'	=> $element['qfeatures']['write_caller']['default'],
				      'checked'	=> $info['qfeatures']['write_caller'])),

		$form->checkbox(array('desc'	=> $this->bbf('fm_qfeatures_write-calling'),
				      'name'	=> 'qfeatures[write_calling]',
				      'labelid'	=> 'qfeatures-write-calling',
				      'default'	=> $element['qfeatures']['write_calling']['default'],
				      'checked'	=> $info['qfeatures']['write_calling']));
?>
</div>
...
if($context_list !== false):
	...
	echo	$form->text(array('desc'	=> $this->bbf('fm_queue_servicelevel'),
		...
		$form->select(array('desc'	=> $this->bbf('fm_queue_timeout'),
				    ...
				    'key'	=> false,
				    'bbf'	=> array('paramkey','fm_queue_timeout-opt'),
				    'default'	=> $element['queue']['timeout']['default'],
				    'value'	=> $info['queue']['timeout']),
		...
		$form->select(array('desc'	=> $this->bbf('fm_queue_retry'),
				    ...
				    'labelid'	=> 'queue-retry',
				    'key'	=> false,
				    'bbf'	=> array('paramkey','fm_queue_retry-opt'),
				    'default'	=> $element['queue']['retry']['default'],
				    'value'	=> $info['queue']['retry']),
		...
		$form->select(array('desc'	=> $this->bbf('fm_queue_wrapuptime'),
				    ...
				    'key'	=> false,
				    'bbf'	=> array('paramkey','fm_queue_wrapuptime-opt'),
				    'default'	=> $element['queue']['wrapuptime']['default'],
				    'value'	=> $info['queue']['wrapuptime']),
		...
		$form->select(array('desc'	=> $this->bbf('fm_queue_monitor-type'),
				    ...
				    'empty'	=> true,
				    'key'	=> false,
				    'bbf'	=> array('paramkey','fm_queue_monitor-type-opt'),
				    'default'	=> $element['queue']['monitor-type']['default'],
				    'value'	=> $info['queue']['monitor-type']),
		...
		$form->select(array('desc'	=> $this->bbf('fm_queue_monitor-format'),
				    ...
				    'value'	=> $info['queue']['monitor-format']),
		...
		$form->select(array('desc'	=> $this->bbf('fm_queue_joinempty'),
				    ...
				    'key'	=> false,
				    'bbf'	=> array('paramkey','fm_queue_joinempty-opt'),
				    'default'	=> $element['queue']['joinempty']['default'],
				    'value'	=> $info['queue']['joinempty']),
		...
		$form->select(array('desc'	=> $this->bbf('fm_queue_leavewhenempty'),
				    ...
				    'key'	=> false,
				    'bbf'	=> array('paramkey','fm_queue_leavewhenempty-opt'),
		...
		$form->select(array('desc'	=> $this->bbf('fm_queue_memberdelay'),
				    ...
				    'key'	=> false,
				    'bbf'	=> array('paramkey','fm_queue_memberdelay-opt'),
				    'default'	=> $element['queue']['memberdelay']['default'],
				    'value'	=> $info['queue']['memberdelay']),
