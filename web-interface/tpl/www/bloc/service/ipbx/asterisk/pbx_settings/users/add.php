...
<form action="#" method="post" accept-charset="utf-8" onsubmit="xivo_fm_select('it-group'); xivo_fm_select('it-queue'); xivo_fm_select('it-'+xivo_protocol+'-codec'); xivo_fm_select('it-rightcall');">
