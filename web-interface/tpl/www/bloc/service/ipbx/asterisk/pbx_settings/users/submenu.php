	<div class="sb-smenu">
		<ul>
			...
			<li id="smenu-tab-2" class="moo" onclick="xivo_smenu_click(this,'moc','sb-part-group');" onmouseout="xivo_smenu_out(this,'moo');" onmouseover="xivo_smenu_over(this,'mov');">
				<div><span class="span-center"><a href="#" onclick="xivo_smenu_click(this,'moc','sb-part-group'); return(false);"><?=$this->bbf('smenu_groups');?></a></span></div><span class="span-right">&nbsp;</span>
			</li>
			...
			<li id="smenu-tab-4" class="moo" onclick="xivo_smenu_click(this,'moc','sb-part-voicemail');" onmouseout="xivo_smenu_out(this,'moo');" onmouseover="xivo_smenu_over(this,'mov');">
				<div><span class="span-center"><a href="#" onclick="xivo_smenu_click(this,'moc','sb-part-voicemail'); return(false);"><?=$this->bbf('smenu_voicemail');?></a></span></div><span class="span-right">&nbsp;</span>
			</li>
