...
<?=$form->text(array('desc' => $this->bbf('fm_ldapfilter_name'),'name' => 'ldapfilter[name]','labelid' => 'ldapfilter-name','size' => 15,'default' => $element['ldapfilter']['name']['default'],'value' => $info['ldapfilter']['name']));?>
...
<?=$form->text(array('desc' => $this->bbf('fm_ldapfilter_user'),'name' => 'ldapfilter[user]','labelid' => 'ldapfilter-user','size' => 15,'default' => $element['ldapfilter']['user']['default'],'value' => $info['ldapfilter']['user']));?>

<?=$form->text(array('desc' => $this->bbf('fm_ldapfilter_passwd'),'name' => 'ldapfilter[passwd]','labelid' => 'ldapfilter-passwd','size' => 15,'default' => $element['ldapfilter']['passwd']['default'],'value' => $info['ldapfilter']['passwd']));?>

<?=$form->text(array('desc' => $this->bbf('fm_ldapfilter_basedn'),'name' => 'ldapfilter[basedn]','labelid' => 'ldapfilter-basedn','size' => 30,'default' => $element['ldapfilter']['basedn']['default'],'value' => $info['ldapfilter']['basedn']));?>

<?=$form->text(array('desc' => $this->bbf('fm_ldapfilter_filter'),'name' => 'ldapfilter[filter]','labelid' => 'ldapfilter-filter','size' => 30,'notag' => false,'default' => $element['ldapfilter']['filter']['default'],'value' => $info['ldapfilter']['filter']));?>

<?=$form->select(array('desc' => $this->bbf('fm_ldapfilter_additionaltype'),'name' => 'ldapfilter[additionaltype]','labelid' => 'ldapfilter-additionaltype','bbf' => array('concatkey','fm_ldapfilter_additionaltype-opt-'),'key' => false,'default' => $element['ldapfilter']['additionaltype']['default'],'value' => $info['ldapfilter']['additionaltype']),$element['ldapfilter']['additionaltype']['value'],'onchange="xivo_chg_additionaltype(this.value);"');?>

<?=$form->text(array('desc' => '&nbsp;','name' => 'ldapfilter[additionaltext]','labelid' => 'ldapfilter-additionaltext','size' => 15,'default' => $element['ldapfilter']['additionaltext']['default'],'value' => $info['ldapfilter']['additionaltext']));?>

<div class="fm-field fm-description"><p><label id="lb-ldapfilter-description" for="it-ldapfilter-description"><?=$this->bbf('fm_ldapfilter_description');?></label></p>
<?=$form->textarea(array('field' => false,'label' => false,'name' => 'ldapfilter[description]','id' => 'it-ldapfilter-description','cols' => 60,'rows' => 5,'default' => $element['ldapfilter']['description']['default']),$info['ldapfilter']['description']);?>
</div>
...
<fieldset id="fld-ldapfilter-attrdisplayname">
	...
	<div class="fm-field fm-multilist">
		...
		<div class="slt-list">
			...
			<?=$form->select(array('name' => 'ldapfilter[attrdisplayname][]','label' => false,'id' => 'it-ldapfilter-attrdisplayname','key' => false,'multiple' => true,'size' => 5,'field' => false),$info['ldapfilter']['attrdisplayname']);?>
...
<fieldset id="fld-ldapfilter-attrphonenumber">
	...
	<div class="fm-field fm-multilist">
		...
		<div class="slt-list">
			...
			<?=$form->select(array('name' => 'ldapfilter[attrphonenumber][]','label' => false,'id' => 'it-ldapfilter-attrphonenumber','key' => false,'multiple' => true,'size' => 5,'field' => false),$info['ldapfilter']['attrphonenumber']);?>
