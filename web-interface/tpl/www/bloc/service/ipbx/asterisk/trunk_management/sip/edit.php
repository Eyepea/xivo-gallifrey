...
<?=$form->text(array('name' => 'trunk[host-static]','labelid' => 'trunk-host-static','size' => 15,'value' => ($host_static === true ? $host : '')),'onfocus="this.className=\'it-mfocus\';" onblur="this.className=\'it-mblur\';"');?>
...
<?=$form->checkbox(array('desc' => $this->bbf('fm_register'),'name' => 'register-active','id' => 'it-register','checked' => $reg_active),'onclick="xivo_eid(\'register\').style.display = this.checked == true ? \'block\' : \'none\';"');?>

<div id="register"<?=($reg_active !== true ? ' class="b-nodisplay"' : '')?>>
