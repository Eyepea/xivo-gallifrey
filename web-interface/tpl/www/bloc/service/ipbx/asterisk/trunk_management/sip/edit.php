<?php
	...
	$allow = $this->varra('info',array('trunk','allow'));
	...
	if((string) ($host = $this->varra('info',array('trunk','host-static'))) !== ''):
		$host_static = true;
	elseif(($host = $this->varra('info',array('trunk','host'))) === 'dynamic' || (string) $host === ''):
		$host_static = false;
	else:
		$host_static = true;
	endif;
...
<?=$form->checkbox(array('desc' => $this->bbf('fm_register'),'name' => 'register-active','labelid' => 'register-active','checked' => $reg_active),'onfocus="this.className=\'it-mfocus\';" onblur="this.className=\'it-mblur\';" onclick="xivo_chg_attrib(\'fm_register\',\'it-register-username\',(this.checked == true ? 1 : 2))"');?>
...
<?=$form->checkbox(array('desc' => $this->bbf('fm_codec-custom'),'name' => 'codec-active','labelid' => 'codec-active','checked' => $codec_active),'onfocus="this.className=\'it-mfocus\';" onblur="this.className=\'it-mblur\';" onclick="xivo_chg_attrib(\'fm_codec\',\'it-trunk-disallow\',(this.checked == true ? 1 : 2))"');?>
...
<?=$form->text(array('desc' => $this->bbf('fm_trunk_port'),'name' => 'trunk[port]','labelid' => 'trunk-port','default' => $element['trunk']['port']['default'],'size' => 15,'value' => $this->varra('info',array('trunk','port'))),'onfocus="this.className=\'it-mfocus\';" onblur="this.className=\'it-mblur\';"');?>
