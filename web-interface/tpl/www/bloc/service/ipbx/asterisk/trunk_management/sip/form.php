...
<?=$form->checkbox(array('desc' => $this->bbf('fm_register'),'name' => 'register-active','labelid' => 'register-active','checked' => $reg_active),'onfocus="this.className=\'it-mfocus\';" onblur="this.className=\'it-mblur\';" onclick="xivo_chg_attrib(\'fm_register\',\'it-register-username\',(this.checked == true ? 0 : 1))"');?>
...
<?=$form->slt(array('desc' => $this->bbf('fm_trunk_dtmfmode'),'name' => 'trunk[dtmfmode]','labelid' => 'trunk-dtmfmode','key' => false,'default' => $element['trunk']['dtmfmode']['default'],'value' => $info['trunk']['dtmfmode']),$element['trunk']['dtmfmode']['value'],'onfocus="this.className=\'it-mfocus\';" onblur="this.className=\'it-mblur\';"');?>
...
<?=$form->checkbox(array('desc' => $this->bbf('fm_trunk_insecure'),'name' => 'trunk[insecure]','labelid' => 'trunk-insecure','default' => $element['trunk']['insecure']['default'],'checked' => $info['trunk']['insecure']),'onfocus="this.className=\'it-mfocus\';" onblur="this.className=\'it-mblur\';"');?>
