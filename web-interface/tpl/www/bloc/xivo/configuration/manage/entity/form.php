...
echo	$form->text(array('desc'	=> $this->bbf('fm_name'),
	...
	$form->text(array('desc'	=> $this->bbf('fm_displayname'),
	          ...
	          'error'	=> $this->bbf_args('displayname',
	...
	$form->text(array('desc'	=> $this->bbf('fm_phonenumber'),
	          ...
	          'error'	=> $this->bbf_args('phonenumber',
