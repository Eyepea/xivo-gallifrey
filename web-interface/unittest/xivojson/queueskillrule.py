...
class Test21QueueskillRule(unittest.TestCase):
    def setUp(self):
        global IP, PORT, SSL, USERNAME, PASSWORD

        self.client = JSONClient(IP, PORT, SSL, USERNAME, PASSWORD)
        self.obj    = 'queueskillrules'

    def test_01_queueskillrule(self):
...
#        pprint.pprint(data)
        ...
        # ADD
        with open('xivojson/queueskillrule.json') as f:
...
#        pprint.pprint(data)
        ...
        self.assertTrue(data['name'] == 'boucherie sandoz')
