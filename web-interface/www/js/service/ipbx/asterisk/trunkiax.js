...
xivo_elt_protocol['it-protocol-username']['property'] = {readOnly: false, className: 'it-enabled'};
...
xivo_fm_protocol['user']['it-protocol-username']['property'] = {readOnly: false, className: 'it-enabled'};
...
xivo_fm_protocol['friend']['it-protocol-username']['property'] = {readOnly: true, className: 'it-readonly'};
