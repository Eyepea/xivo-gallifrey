...
xivo_fm_trunk['peer']['fds-peer']['link'][xivo_ipeer++] = new Array('fd-trunk-fromuser',0,1);
xivo_fm_trunk['peer']['fds-peer']['link'][xivo_ipeer++] = new Array('it-trunk-fromuser',0,1);
xivo_fm_trunk['peer']['fds-peer']['link'][xivo_ipeer++] = new Array('fd-trunk-fromdomain',0,1);
xivo_fm_trunk['peer']['fds-peer']['link'][xivo_ipeer++] = new Array('it-trunk-fromdomain',0,1);
