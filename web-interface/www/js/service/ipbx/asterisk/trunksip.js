...
xivo_elt_protocol['it-protocol-port']['property'] = {disabled: false};
...
xivo_elt_protocol['it-protocol-host-dynamic']['property'] = {disabled: false};
...
xivo_elt_protocol['it-protocol-host-static']['property'] = {disabled: false};
...
xivo_elt_protocol['it-protocol-qualify']['property'] = {disabled: false};
...
xivo_elt_protocol['it-protocol-fromuser']['property'] = {disabled: false};
...
xivo_elt_protocol['it-protocol-fromdomain']['property'] = {disabled: false};
...
xivo_fm_protocol['user']['it-protocol-port']['property'] = {disabled: true};
xivo_fm_protocol['user']['fd-protocol-host-dynamic']['style'] = {display: 'none'};
xivo_fm_protocol['user']['it-protocol-host-dynamic']['property'] = {disabled: true};
xivo_fm_protocol['user']['fd-protocol-host-static']['style'] = {display: 'none'};
xivo_fm_protocol['user']['it-protocol-host-static']['property'] = {disabled: true};
xivo_fm_protocol['user']['fd-protocol-qualify']['style'] = {display: 'none'};
xivo_fm_protocol['user']['it-protocol-qualify']['property'] = {disabled: true};
xivo_fm_protocol['user']['fd-protocol-fromuser']['style'] = {display: 'none'};
xivo_fm_protocol['user']['it-protocol-fromuser']['property'] = {disabled: true};
xivo_fm_protocol['user']['fd-protocol-fromdomain']['style'] = {display: 'none'};
xivo_fm_protocol['user']['it-protocol-fromdomain']['property'] = {disabled: true};
...
xivo_fm_codec['it-protocol-disallow']['property'] = new Array({disabled: false, className: 'it-enabled'},
...
xivo_fm_codec['it-codeclist']['property'] = new Array({disabled: false, className: 'it-enabled'},
...
xivo_fm_codec['it-codec']['property'] = new Array({disabled: false, className: 'it-enabled'},
						  {disabled: true, className: 'it-disabled', selectedIndex: -1});
...
xivo_fm_register['it-register-username']['property'] = new Array({disabled: false, className: 'it-enabled'},
								 {disabled: true, className: 'it-disabled'});
xivo_fm_register['it-register-username']['link'] = 'it-register-password';

xivo_fm_register['it-register-password'] = new Array();
xivo_fm_register['it-register-password']['property'] = new Array({disabled: false, className: 'it-enabled'},
								 {disabled: true, className: 'it-disabled'});
xivo_fm_register['it-register-password']['link'] = 'it-register-authuser';

xivo_fm_register['it-register-authuser'] = new Array();
xivo_fm_register['it-register-authuser']['property'] = new Array({disabled: false, className: 'it-enabled'},
								 {disabled: true, className: 'it-disabled'});
xivo_fm_register['it-register-authuser']['link'] = 'it-register-host';

xivo_fm_register['it-register-host'] = new Array();
xivo_fm_register['it-register-host']['property'] = new Array({disabled: false, className: 'it-enabled'},
							     {disabled: true, className: 'it-disabled'});
xivo_fm_register['it-register-host']['link'] = 'it-register-port';

xivo_fm_register['it-register-port'] = new Array();
xivo_fm_register['it-register-port']['property'] = new Array({disabled: false, className: 'it-enabled'},
							     {disabled: true, className: 'it-disabled'});
xivo_fm_register['it-register-port']['link'] = 'it-register-contact';

xivo_fm_register['it-register-contact'] = new Array();
xivo_fm_register['it-register-contact']['property'] = new Array({disabled: false, className: 'it-enabled'},
								{disabled: true, className: 'it-disabled'});
...
function xivo_ast_trunk_sip_onload()
{
	...
	if((regactive = xivo_eid('it-register-active')) != false)
		xivo_chg_attrib('fm_register','it-register-username',Number(regactive.checked === false));

	if((codecative = xivo_eid('it-codec-active')) != false)
		xivo_chg_attrib('fm_codec','it-protocol-disallow',Number(codecative.checked === false));
}
